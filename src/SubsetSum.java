...
public class SubsetSum {
     ...
     */
    public static void sumOfSubset(int[] numbers, int desiredSum, int sumOfAnalyzedItems, int currentItemIdx, int sumOfLeftItems, Boolean[] currentSolution, List<List<Integer>> solutions) {
        // generate left child
        ...
        if (sumOfAnalyzedItems+numbers[currentItemIdx] == desiredSum) { // solution has been found
            ...
            for (int i=0; i<numbers.length; i++) {
                if (currentSolution[i] == null) break; // from now on numbers have not been investigated
